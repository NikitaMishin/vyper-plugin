package org.vyperlang.plugin.toolWindow
...
object VyperWindow {
    ...
    internal const val ID_COMPILER_TAB = "Compiler Output"
     ...
     */
    internal fun getTabById(project: Project, tabId: String): JTextPane {
