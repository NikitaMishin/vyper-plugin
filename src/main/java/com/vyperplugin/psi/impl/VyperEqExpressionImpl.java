...
import com.vyperplugin.psi.VyperEqExpression;
...
public class VyperEqExpressionImpl extends VyperExpressionImpl implements VyperEqExpression {

  public VyperEqExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
