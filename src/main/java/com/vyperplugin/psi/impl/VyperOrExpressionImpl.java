...
import com.vyperplugin.psi.VyperOrExpression;
import com.vyperplugin.psi.VyperVisitor;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class VyperOrExpressionImpl extends VyperExpressionImpl implements VyperOrExpression {

  public VyperOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
